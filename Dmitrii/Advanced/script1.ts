...
class Vehicle {
  ...
  constructor(mark: string, model: string, color: string, mileage: number, seatsNumber: number, fuelType: string, year: number, condition: string, consumption: number, price: number, wheels: number) {
    this.mark = mark;
    this.model = model;
    this.color = color;
...
class PassengerCar extends Vehicle {
  doors: number;
  drive: string;
  constructor(mark: string, model: string, color: string, mileage: number, seatsNumber: number, fuelType: string, year: number, condition: string, consumption: number, price: number, wheels: number, doors: number, drive: string) {
...
class Truck extends Vehicle {
  ...
  capacity: number;
  winches: number;
  constructor(mark: string, model: string, color: string, mileage: number, seatsNumber: number, fuelType: string, year: number, condition: string, consumption: number, price: number, wheels: number, type: string, capacity: number, winches: number) {
    super(mark, model, color, mileage, seatsNumber, fuelType, year, condition, consumption, price, wheels);
    this.type = type;
...
class Motorbike extends Vehicle {
  ...
  drive: string;
  motor: string;
  constructor(mark: string, model: string, color: string, mileage: number, seatsNumber: number, fuelType: string, year: number, condition: string, consumption: number, price: number, wheels: number, drive: string, motor: string) {
    super(mark, model, color, mileage, seatsNumber, fuelType, year, condition, consumption, price, wheels);
    this.drive = drive;
    this.motor = motor;
  }
...
class Bus extends Vehicle {
  ...
  constructor(mark: string, model: string, color: string, mileage: number, seatsNumber: number, fuelType: string, year: number, condition: string, consumption: number, price: number, wheels: number, luggageRack: string, readingLights: string) {
    super(mark, model, color, mileage, seatsNumber, fuelType, year, condition, consumption, price, wheels);
